...
static ELIXIR: Lazy<HighlightConfiguration> = Lazy::new(|| {
...
static RUBY: Lazy<HighlightConfiguration> = Lazy::new(|| {
    let mut config = HighlightConfiguration::new(
...
static RUST: Lazy<HighlightConfiguration> = Lazy::new(|| {
    let mut config = HighlightConfiguration::new(
...
static SWIFT: Lazy<HighlightConfiguration> = Lazy::new(|| {
    let mut config = HighlightConfiguration::new(
