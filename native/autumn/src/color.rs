// Copied from Zed text editor
// Licensed under the Apache License, Version 2.0
// https://github.com/zed-industries/zed/blob/3737d4eb4fa9e576204a367b020ba189ac4aa087/crates/gpui/src/color.rs

// Do not change this file adding more code to it.
// It should be exactly the same as the original file to facilitate maintenance.
